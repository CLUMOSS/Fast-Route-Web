...
const CareerOpening = () => {
  return (
    <div className={styles.CareerOpening}>
      ...
      <div className={styles.CareerOpeningHead}>
        <h1 className={styles.CareerOpeningHeading}>Job Openings</h1>
      </div>

      <div className={styles.CareerInputs}>
        <input type="text" placeholder="Search" className={styles.CareerInput} />
        ...
        <button className={styles.btn2} type="button">Filters</button>
        <button className={styles.btn4} type="button">Search</button>

      </div>

      <div className={styles.openBox}>
        <div className={styles.openText}>
          <h2 className={styles.openHead}>Product Designer</h2>
          <p className={styles.openPara}>We&apos;re looking for a mid-level product designer to join our team</p>
        </div>
        ...
        <div className={styles.CareerOpenApply}>
          <a href="#" className={styles.CareerApplyLink}>Apply</a>
        </div>
      </div>

      <div className={styles.openBox}>
        <div className={styles.openText}>
          <h2 className={styles.openHead}>Engineer Manager</h2>
          <p className={styles.openPara}>We're looking for an experienced engineering manager to join our team</p>
        </div>
        <div className={styles.openBtn}>
          <button type="button" className={styles.btn3}>
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
